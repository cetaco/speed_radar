...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SENSOR_DISTANCE_MM, 4000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SPEED_LIMIT_LIGHT_KMH, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SPEED_LIMIT_HEAVY_KMH, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_WARNING_THRESHOLD_PERCENT, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_CAMERA_FAILURE_RATE_PERCENT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CMSDK_DTIMER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CMSDK_GPIO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CMSDK_TIMER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CMSDK_UART_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CMSDK_WATCHDOG_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CORTEX_M3_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_MMIO32_GPIO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_MPS2_PINCTRL_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_V7M_NVIC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_VERSATILE_I2C_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SMSC_LAN9220_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MPS2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MPS2_AN385, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_ICOUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_ICOUNT_SHIFT, 7);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_MPS2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_MPS2_AN385, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_CMSDK_AHB, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PINCTRL_ARM_MPS2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_CMSDK_APB, 1);
